...
void analyzeStream(SIGNATURE Signature, char *tfile, FILE *bad_out, 
...
int main(int argc, char *argv[]) {
  ...
  analyzeStream(Signature, tfile, bad_out, lc, obviousness, complexity, 
  ...
  #endif
  if (AxHead != NULL) {
    analyzeAgain(AxHead, good_out, bad_out, obviousness, complexity, 
		 intensity, surprisingness, adaptivity, focus, weight);
  } else {
