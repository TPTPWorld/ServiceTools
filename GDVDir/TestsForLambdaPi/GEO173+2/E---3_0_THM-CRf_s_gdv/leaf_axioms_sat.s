...
Paradox---4.0's leaf_axioms_sat being prepared by /exp/home/tptp/ServiceTools/tptp4X
    -d /tmp/SystemOnTPTP58886 
    -t none 
    -f tptp:short
    -x 
    -u machine
    TestsForLambdaPi/GEO173+2/E---3_0_THM-CRf_s_gdv/leaf_axioms_sat.p
Paradox---4.0   will use /tmp/SystemOnTPTP58886/leaf_axioms_sat.tptp:short
...
Paradox---4.0   being executed on leaf_axioms_sat using /exp/home/tptp/Systems/Paradox---4.0/paradox --no-progress --time 60 --tstp --model '/tmp/SystemOnTPTP58886/leaf_axioms_sat.tptp:short'
% START OF SYSTEM OUTPUT
Paradox, version 4.0, 2010-06-29.
+++ PROBLEM: /tmp/SystemOnTPTP58886/leaf_axioms_sat.tptp:short
Reading '/tmp/SystemOnTPTP58886/leaf_axioms_sat.tptp:short' ... OK
+++ SOLVING: /tmp/SystemOnTPTP58886/leaf_axioms_sat.tptp:short
+++ BEGIN MODEL
SZS output start FiniteModel for /tmp/SystemOnTPTP58886/leaf_axioms_sat.tptp:short
% domain size is 1
...
SZS output end FiniteModel for /tmp/SystemOnTPTP58886/leaf_axioms_sat.tptp:short
+++ END MODEL
+++ RESULT: Satisfiable
SZS status Satisfiable for /tmp/SystemOnTPTP58886/leaf_axioms_sat.tptp:short
