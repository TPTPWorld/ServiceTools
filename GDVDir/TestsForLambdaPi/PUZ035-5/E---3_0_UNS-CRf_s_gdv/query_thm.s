...
ZenonModuloLP---0.4.2   checking problem name TestsForLambdaPi/PUZ035-5/E---3_0_UNS-CRf_s_gdv/query_thm.p

ZenonModuloLP---0.4.2's TPTP format TestsForLambdaPi/PUZ035-5/E---3_0_UNS-CRf_s_gdv/query_thm.p is ...
fof(query,axiom,
    ! [Y,X] :
      ( ~ truth(isa(asked,X))
      | ~ truth(isa(other,Y)) ) ).
...
ZenonModuloLP---0.4.2's query_thm does not need preparation
ZenonModuloLP---0.4.2   will use TestsForLambdaPi/PUZ035-5/E---3_0_UNS-CRf_s_gdv/query_thm.p
...
ZenonModuloLP---0.4.2   being executed on query_thm using /exp/home/tptp/Systems/ZenonModuloLP---0.4.2/run_zenon_modulo 60 'TestsForLambdaPi/PUZ035-5/E---3_0_UNS-CRf_s_gdv/query_thm.p'
...
RESULT: query_thm - ZenonModuloLP---0.4.2 says Theorem - CPU = 0.00 WC = 0.09 
OUTPUT: query_thm - ZenonModuloLP---0.4.2 says Assurance - CPU = 0.00 WC = 0.09 
