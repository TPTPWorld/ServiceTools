...
public interface TptpParserOutput {
    ...
    /** Must be implemented by a class representing formula structures
     *  corresponding to instances of &#60tff formula&#62 in the BNF grammar.
     */
    public static interface TffFormula {
      // nothing here
    }; // static interface TffFormula
     ...
     */
    public static interface TffAtomicFormula {
      // nothing here
    }; // static interface TffAtomicFormula
...
TptpParserOutput.ThfFormula formula);
    ...
    public 
      TffFormula 
      createTffBinaryFormula(TffFormula lhs,
                  BinaryConnective connective,
                  TffFormula rhs);
    ...
    public 
    TffFormula
    createTffNegationOf(TffFormula formula);
    ...
    public 
    TffFormula
    createTffQuantifiedFormula(Quantifier quantifier,
                      Iterable<TffFormula> variableList,
                      TffFormula formula);
     ...
     *  @param atom != null
     */
    public TffFormula tffAtomAsTffFormula(TffAtomicFormula atom);
    ...
    */
     ...
     *  @param formula
     */
    public GeneralTerm createGeneralTffFormula(TffFormula formula);
     ...
     *  @param formula
     */
    public GeneralTerm createGeneralCnfFormula(CnfFormula formula);

    /** A correct implementation must return an object representing
     *  a formula
     *  @param formula
     */
    public GeneralTerm createGeneralTerm(Term term);
